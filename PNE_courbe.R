...
graphe <- read.csv2("sorties/pne/pne_24 - Copie.csv",header = F)
...
legend(8,20,legend = rownames(graphe), pch=1,col = couleurs, cex=0.8,bty="n",lwd=1,lty = c(1,1,3))
...
legend(7,17,legend = rownames(graphe), pch=1:2,col = couleurs, cex=0.8,bty="n",lwd=1,lty = 3)
